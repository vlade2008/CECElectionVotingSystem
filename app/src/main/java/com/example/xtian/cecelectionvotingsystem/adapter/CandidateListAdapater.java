 ...
 */
public class CandidateListAdapater extends ArrayAdapter<candidateItem> {

    Context context;
    int layoutResourceId;
    ArrayList<candidateItem> candidateArray = new ArrayList<candidateItem>();

    public CandidateListAdapater(Context context, int layoutResourceId, ArrayList<candidateItem> candidateArray) {
